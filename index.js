...
const STAGING_BUCKET = "quarantine_bucket" // The bucket the to-be-scanned files are uploaded to
const NONSENSITIVE_BUCKET = "non_sensitive_data" // The bucket to move "safe" files to
const SENSITIVE_BUCKET = "sensitive_data" // The bucket to move "unsafe" files to
